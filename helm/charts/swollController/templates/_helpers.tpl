...
{{- define "swoll-controller.helm_std_labels" }}
...
{{- define "swoll-controller.annotations" }}
...
*/}}
{{- define "swoll-controller.fullname" -}}
...
{{- if .Values.serviceAccount.create -}}
    {{ default (include "swoll-controller.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
